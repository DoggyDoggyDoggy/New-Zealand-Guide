...
class MaoriWordsRepositoryImplTest {
    private val repository = MaoriWordsRepositoryImpl()

    @Test
    fun `getMaoriWords should return all predefined words and translations`() {
        val expectedWordsMap = mapOf(
        ...
        val expected = MaoriWords(words = expectedWordsMap)

        val actual = repository.getMaoriWords()
