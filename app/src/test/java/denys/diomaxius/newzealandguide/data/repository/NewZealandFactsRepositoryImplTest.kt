...
class NewZealandFactsRepositoryImplTest {
    private val repository = NewZealandFactsRepositoryImpl()

    @Test
    fun `getNewZealandFacts should return all predefined facts`() {
        val expectedFactsList = listOf(
        ...
        val expected = NewZealandFacts(facts = expectedFactsList)

        val actual = repository.getNewZealandFacts()
